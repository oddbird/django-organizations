    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization', models.ForeignKey(related_name='organization_users', to='accounts.Account', on_delete=models.CASCADE)),
                ('user', models.ForeignKey(related_name='accounts_accountuser', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
            ],
            options={
